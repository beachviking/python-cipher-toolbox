...
ENGLISH_LETTER_FREQ = [0.08167,0.01492,0.02782,0.04253,0.12702,0.02228,0.02015,0.06094,0.06966,0.00153,0.00772,0.04025,0.02406,0.06749,0.07507,0.01929,0.00095,0.05987,0.06327,0.09056,0.02758,0.00978,0.02360,0.00150,0.01974,0.00074]
...
def chi_squared(text: str, letter_freq_dist = ENGLISH_LETTER_FREQ, alphabet = ALPHABET) -> float:
...
class MyPrompt(Cmd):
    ...
    def do_vencrypt(self, args = None):
        ...
        self.cryptodata.cipher_text = vigenere_encrypt(self.cryptodata.plain_text, self.cryptodata.key)
        self.print_crypto_data()
    ...
    def do_vdecrypt(self, args = None):
        ...
        self.cryptodata.plain_text = vigenere_decrypt(self.cryptodata.cipher_text, self.cryptodata.key)
        self.print_crypto_data()
    ...
    def do_cencrypt(self, args = None):
        ...
        self.cryptodata.cipher_text = caesar_encrypt(self.cryptodata.plain_text, self.cryptodata.key)
        self.print_crypto_data()
    ...
    def do_cdecrypt(self, args = None):
        ...
        self.cryptodata.key = self.cryptodata.key[0]
        self.cryptodata.plain_text = caesar_decrypt(self.cryptodata.cipher_text, self.cryptodata.key)
        self.print_crypto_data()
    ...
    def do_vguess(self, args):
        ...
        self.print_vguess(guess_vigenere_key(self.cryptodata.cipher_text, self.cryptodata.keyperiod))
